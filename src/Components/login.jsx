  ...
  return (
     <div className="flex h-screen w-screen bg-gradient-to-b from-greenC to-greenCD justify-center align-center">
        <div className="m-auto text-center">
            ...
            <button className="w-96 bg-green-800 p-3 mt-4 -ml-4 rounded-lg text-white" onClick={event =>  window.location.href='/'}>Login</button>
            <div className="flex mt-6 gap-x-28">
                <div className="text-sm text-white underline ml-1 cursor-pointer" onClick={event => window.location.href='/reset'}>Forgot Your Password?</div>
                <div className="text-sm text-white underline ml-1 cursor-pointer" onClick={event => window.location.href='/signup'}>Click here to sign up</div>
            </div>
            <div>
                <button className="flex flex-row bg-white w-96 text-center justify-center p-3 mt-10 rounded-md">
                    ...
                    <div className="font-semibold">Login wih Google</div>
                </button>
            </div>
        </div>
     </div>
