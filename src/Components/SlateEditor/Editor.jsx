...
const SlateEditor = ()=>{
    ...
    return (
            <Slate editor = {editor} value = {value} onChange = {newValue => setValue(newValue)}  >
                ...
                <div className="realtive editor-wrapper" style={{border:'1px solid #f3f3f3',padding:'0 10px'}}>
                    <Editable
                        placeholder='Write something'
                        renderElement={renderElement} 
                        renderLeaf={renderLeaf}
                    />
                    <button className='absolute right-0 -bottom-10 h-10 mr-24 mb-48 bg-greenC px-5 py-2 rounded-md text-white'>submit</button>
                </div>
        </Slate>
