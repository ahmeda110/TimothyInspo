...
function HomePage() {
  ...
  return (
    <div className={`flex`}>
        ...
        <div className={"flex justify-between p-10 px-20"}>
          <div className={"flex flex-col p-0 m-0 relative"}>
            <h1 class="libraryT text-black origin-left font-bold relative -top-2">
              {window.location.pathname.split("/")[2].replaceAll("%20", " ")}: &nbsp;&nbsp;<span className="text-green-600 text-2xl font-semibold -mr-1">#</span> <span className="text-2xl font-semibold">{window.location.pathname.split("/")[3].replaceAll("%20", " ")}</span>
            </h1>
            <p className={"-mt-3 text-gray-400"}>Description of board goes here.</p>
          </div>
      ...
      <div className={"flex h-max m-auto mt-96"}>
        <div className="m-auto text-center">
            <div className="text-3xl font-bold">This board is empty</div>
            <div className="text-sm">Create a board and save your ads.</div>
